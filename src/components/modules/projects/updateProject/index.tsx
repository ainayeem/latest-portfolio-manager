                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input {...field} value={field.value || ""} placeholder="Enter your project title" />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input {...field} value={field.value || ""} placeholder="Enter thumbnail URL" />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Textarea className="min-h-52" {...field} value={field.value || ""} placeholder="Enter project description" />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input {...field} value={field.value || ""} placeholder="Enter live project link" />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
              ...
              <div className="flex-1">
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>
                        Frontend Source Code <span className="text-red-500">*</span>
                      </FormLabel>
                      <FormControl>
                        <Input {...field} value={field.value || ""} placeholder="Enter frontend source code URL" />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input type="url" {...field} value={field.value || ""} placeholder="Enter backend source code URL" />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input type="url" {...field} value={field.value || ""} placeholder="Enter API documentation URL" />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
